...
public class ShippingShopScreen extends AbstractContainerScreen<ShippingBinMenu> {
    ...
    public ShippingShopScreen(ShippingBinMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
