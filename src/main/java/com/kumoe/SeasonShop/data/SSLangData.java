...
public enum SSLangData {
    ...
    SHIPPING_BIN_TOOLTIP_3("block.season_shop.shipping_bin.tooltip_3", "箱子是空的！", 0, ChatFormatting.RED),
    ...
    SHIPPING_BIN_TOOLTIP_6("block.season_shop.shipping_bin.tooltip_6", "出售物品价值: %s", 1, ChatFormatting.GOLD),
