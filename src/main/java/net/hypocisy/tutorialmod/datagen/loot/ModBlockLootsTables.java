package net.hypocisy.tutorialmod.datagen.loot;
...
public class ModBlockLootsTables extends BlockLootSubProvider {
    public ModBlockLootsTables() {
    ...
    protected LootTable.Builder createCopperLikeOreDrops(Block pBlock, Item item) {
        return createSilkTouchDispatchTable(pBlock,
                this.applyExplosionDecay(pBlock,
                        LootItem.lootTableItem(ModItems.SAPPHIRE.get())
